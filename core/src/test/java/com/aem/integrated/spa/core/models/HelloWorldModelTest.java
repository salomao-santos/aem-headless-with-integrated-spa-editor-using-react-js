 ...
 */
package com.aem.integrated.spa.core.models;
...
import com.aem.integrated.spa.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-integrated-spa/components/helloworld");
